...
public class MessageModule extends FactionModule {
    ...
    public static void send(Player player, String message) {
        ...
        if (!faction.getModules().containsKey(ChatMessageExtension.MODULE_REGISTRY))
            faction.getModules().put(ChatMessageExtension.MODULE_REGISTRY, new MessageModule(faction));

        if (faction.getModules().get(ChatMessageExtension.MODULE_REGISTRY) instanceof MessageModule module)
